...
class CompanyChatsScreen extends StatelessWidget {
  ...
  const CompanyChatsScreen({Key? key, required this.isDark}) : super(key: key);
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Container(decoration: AppStyles.companybackgroundDecoration(isDark: isDark)),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Image.asset(
                              'assets/company/icons/sellectedaipageicon.png',
                              width: 26,
                              height: 26,
